...
| [#161](https://github.com/ZhannaM85/my-money/issues/161) | 🔲 Open | FX debug: save log as a .txt file | Copy is too big for Telegram/email. Download/share `my-money-debug.txt`. |
