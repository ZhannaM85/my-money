...
| [#128](https://github.com/ZhannaM85/my-money/issues/128) | ⬜ Open | Chart tooltip closes when scrolling its holdings list | Page scroll should still dismiss (#77); inner tooltip scroll should not. |
