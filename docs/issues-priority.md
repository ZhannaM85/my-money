...
| [#202](https://github.com/ZhannaM85/my-money/issues/202) | 🔍 Pending validation | Update: show excluded holdings so their valuation can still change | Hidden from totals, still on Update. Archived unchanged. |
| [#203](https://github.com/ZhannaM85/my-money/issues/203) | 🔍 Pending validation | Update: scroll to top stops once Save updates is on screen | Save pinned below holdings scroller. Related #191. |
