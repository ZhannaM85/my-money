...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#264](https://github.com/ZhannaM85/my-money/issues/264) | 🔲 Open | Assets list: put institution on its own row | Follow-up to #109. Type and institution should not share one wrapping `·` line. Amount / ⋯ stay. |
---
