...
| [#63](https://github.com/ZhannaM85/my-money/issues/63) | 🔲 Open | Pages deploy fails type-check on Colorful CSS test Node imports | `src/index.css.test.ts` uses `node:fs`; app tsconfig has no Node types. |
