...
| [#54](https://github.com/ZhannaM85/my-money/issues/54) | 🔲 Open | Pinch to zoom charts like Turtle Steps | Pinch in/out on Dashboard (and History) charts should change the history range, matching Turtle Steps; keep zoom buttons. |
