...
| [#272](https://github.com/ZhannaM85/my-money/issues/272) | ⬜ Open | Settings: card-wrap other sections by meaning (like Feature toggles) | Follow-up to #271. Rates / Comparison / Allocation (and bare Preferences) into cards. |
