...
| [#145](https://github.com/ZhannaM85/my-money/issues/145) | 🔲 Open | Show no-data warning instead of the chart when As of has no holdings | As of 2022-12-31 shows 0,00 ₽ but All chart still plots later history. |
