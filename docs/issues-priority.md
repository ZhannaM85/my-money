...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#121](https://github.com/ZhannaM85/my-money/issues/121) | 🔲 Open | Allocation share percentages should convert to one base, not compare raw native amounts | Follow-up to #108: keep native row amounts; All-mode share % uses hidden RUB (not leftover Settings EUR). |
