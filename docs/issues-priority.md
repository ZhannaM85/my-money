...
| [#250](https://github.com/ZhannaM85/my-money/issues/250) | 🔍 Pending validation | Domain test: historicalNetWorth performance at scale | 20 assets × 50 snapshots × 365 dates. Asserts one `indexSnapshotsByAssetId` pass and a time budget. No e2e screenshots. |
