...
| [#88](https://github.com/ZhannaM85/my-money/issues/88) | 🔲 Open | Show amount change vs rate change on Dashboard (FX drop visible before a cash exchange) | Split «за этот месяц»: amounts vs FX vs total. Optional Update rates (fetch only). Not a new snapshot. Related #85, #86. |
