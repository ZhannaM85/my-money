...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#23](https://github.com/ZhannaM85/my-money/issues/23) | 🔲 Open | RUB assets show €0 when base currency is EUR | Device validation says behavior is still wrong: selecting one base currency should normalize mixed-currency assets into one converted total, not effectively show separate native-currency buckets. |
