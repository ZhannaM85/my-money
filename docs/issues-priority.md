...
| [#266](https://github.com/ZhannaM85/my-money/issues/266) | 🔲 Open | Assets list: show original amount under converted values | Follow-up to #129 / #51. Converted ₽ is primary; still show native e.g. $10,000. Same-currency rows stay one amount. |
---
