...
| [#56](https://github.com/ZhannaM85/my-money/issues/56) | 🔲 Open | Chart Y-axis repeats the same compact label on every tick | Live: still identical Y labels. Formatter-only fix is not enough; need a padded domain and unique ticks. |
