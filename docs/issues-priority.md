...
| [#154](https://github.com/ZhannaM85/my-money/issues/154) | 🔍 Pending validation | Dashboard Positions: tap row to reveal Hide (same as Allocation) | Shipped click instead of #146 swipe (scroll stole swipe). Match Allocation #150 tap-to-reveal. |
