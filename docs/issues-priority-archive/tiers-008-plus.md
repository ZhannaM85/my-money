...
| [#218](https://github.com/ZhannaM85/my-money/issues/218) | ✅ Done | What's new stuck at v212 after #214–#217 deploys | Added v214–v216 release notes for #214–#216 (#217 already v213). Validated on-device 2026-09-04. |
| [#217](https://github.com/ZhannaM85/my-money/issues/217) | ✅ Done | Dashboard: scrolling content bleeds over sticky As of date | Padding off scrollport; full-bleed sticky As of flush under header. Validated on-device 2026-09-04. |
...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#223](https://github.com/ZhannaM85/my-money/issues/223) | ✅ Done | CI: History #209 calendar delta test fails when 1M no longer includes 2026-08-10 | History #209 test now selects All so the 2026-08-10 previous snapshot stays in-range for the daily delta. Unblocks Dependabot PR #222. Validated 2026-09-10 — deploy/CI green. |
...
| # | Status | Issue | Notes |
|---|--------|-------|-------|
| [#229](https://github.com/ZhannaM85/my-money/issues/229) | ✅ Done | Missing bottom spacing between last content and tab bar (most pages) | Shared AppShell content-flow inset above the tab bar so last cards/controls are not flush. Validated on-device 2026-09-11. |
...
| [#234](https://github.com/ZhannaM85/my-money/issues/234) | ✅ Done | Split AssetDetailsScreen into ≤500-line modules | Extracted `useAssetDetailsScreen`, update form, Сведения accordion, and snapshot list. Matching test slices moved. No behavior change. Closed 2026-09-13 — refactor; #231 layout still holds. |
| [#235](https://github.com/ZhannaM85/my-money/issues/235) | ✅ Done | Reorganize Ещё into Preferences / Data / About / Developer | Groups More. Developer collapsed; `#fx-debug` / `#root-causes` open it. Widget only on Capacitor Android. Store listing stays parked. Validated on-device 2026-09-13. |
| [#236](https://github.com/ZhannaM85/my-money/issues/236) | ✅ Done | Finish #232: MoneyInput + shared SortableRow on Update/detail | Update + asset-detail amounts use MoneyInput (locale blur, unit, a11y). Assets and Update share SortableRow. Validated on-device 2026-09-13. |
| [#237](https://github.com/ZhannaM85/my-money/issues/237) | ✅ Done | Hydrate book once: SnapshotRepository.getAll + AppShell load | `getAll()` replaces per-asset snapshot reads. AppShell hydrates once + visibility resume. Screens read the store. Generation guard kept. Closed 2026-09-13 after hydrate-once smoke. |
| [#238](https://github.com/ZhannaM85/my-money/issues/238) | ✅ Done | Update: remove leftover grey helper blurb (#230 follow-up) | Dropped `t.update.description` grey-under-title filler. Empty-state copy kept. No InfoHint. Validated on-device 2026-09-13. Header gap follow-up: #262. |
| [#239](https://github.com/ZhannaM85/my-money/issues/239) | ✅ Done | Shared ChartRangeControls; share range Dashboard↔History | One chrome (chips / custom / zoom / pan). Dashboard and History share persisted range; asset-detail range stays local. Validated on-device 2026-09-13. |
| [#240](https://github.com/ZhannaM85/my-money/issues/240) | ✅ Done | Split netWorth module + pre-index snapshots for series | Split totals / holdings / history / allocation / period change. Historical series indexes snapshots by assetId. No formula change. Closed 2026-09-13 — refactor; no on-device pass. |
| [#241](https://github.com/ZhannaM85/my-money/issues/241) | ✅ Done | FX: document real pipeline; remove unused runtime CBR/NBG | `docs/FX.md` is canonical. Deleted unused `fx/cbr` + `fx/nbg` HTTP clients. Generate scripts kept. No third live fetch. Closed 2026-09-13 — docs/dead clients; no on-device pass. |
| [#242](https://github.com/ZhannaM85/my-money/issues/242) | ✅ Done | Layering: no Dexie in features; FX helper; dead folders | Backup UI uses `backupActions`. `shouldFetchFrankfurter` left dashboard. Empty `features/asset-details` removed. Folder map refreshed. Closed 2026-09-13 — layering/docs; no on-device pass. |
| [#243](https://github.com/ZhannaM85/my-money/issues/243) | ✅ Done | Asset detail: fold tracking/destructive actions into Сведения | Exclude / hide / delete live in expanded Details. Native/base chips persist `currencyDisplayMode`. Validated on-device 2026-09-13. |
| [#244](https://github.com/ZhannaM85/my-money/issues/244) | ✅ Done | Unify hide/show chrome: Assets/detail ⋯, Positions tap-to-reveal | Shared overflow menu on Assets + detail (exclude / archive / delete). Positions / Allocation stay tap-to-reveal. Validated on-device 2026-09-13. |
...
| [#263](https://github.com/ZhannaM85/my-money/issues/263) | ✅ Done | Comparison: vertically align Итого with the total amounts | Follow-up to #261. Итого label is min-h-11 + middle-aligned with the total amounts. Horizontal columns stay. Validated on-device 2026-09-13. |
| [#264](https://github.com/ZhannaM85/my-money/issues/264) | ✅ Done | Assets list: put institution on its own row | Follow-up to #109. Institution is its own muted row under the type. Amount / ⋯ stay. Validated on-device 2026-09-13. Greyed «не учитывается»: #265. |
| [#265](https://github.com/ZhannaM85/my-money/issues/265) | ✅ Done | Assets list: drop Не учитывается on excluded rows | Follow-up to #264. Greyed opacity marks excluded; list subtitle no longer repeats «не учитывается в капитале». Validated on-device 2026-09-13. |
