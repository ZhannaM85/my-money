...
export const en: Dictionary = {
  ...
  asset: {
    ...
    addSpendLine: 'Add spending',
    removeSpendLine: (index) => `Remove spending ${index}`,
    spendLineAmount: (index) => `Spending ${index}`,
    spendLineNote: (index) => `Spending ${index} note`,
  },
  update: {
    title: 'Update',
    ...
    spendAmountAria: (name, index) => `${name} spending ${index}`,
    spendNoteAria: (name, index) => `${name} spending ${index} note`,
