...
export const ru: Dictionary = {
  ...
  asset: {
    ...
    headlineGivenSpent: 'Отдано / получено',
    flowGiven: 'Отдано',
    flowReceived: 'Получено',
    resultingRemaining: (amount) => `Новый остаток ${amount}`,
    addSpendLine: 'Добавить запись',
  ...
  settings: {
    ...
    newUpdateUx: 'Обновление с отдано/получено',
    newUpdateUxHint:
      'Экран «Обновить» с отдельными записями отдано/получено и сохранением по полям. Выкл — прежний экран.',
