...
export const ru: Dictionary = {
  ...
  allocation: {
    ...
    descriptionOriginalCurrency:
      'Нативные суммы по валютам. Доли только по размеру — валюты не пересчитываются в один итог.',
    ...
    descriptionOriginalClassType:
      'Нативные суммы по классу или типу — каждая строка в своей валюте. Доли только по размеру; смешанные валюты не пересчитываются в один итог.',
