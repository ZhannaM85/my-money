...
export const ru: Dictionary = {
  ...
  dashboard: {
    ...
    fxMissing: (codes) =>
      `Нет курса ${codes} на эту дату — эта валюта не пересчитана в ₽.`,
    fxDisclaimer: 'Курсы справочные, не банковские котировки.',
    ...
    ratesUpdateOffline: 'Нет сети — показаны сохранённые курсы',
    ratesUpdateFailed: 'Не удалось обновить курсы; показаны сохранённые',
    periodChangeHint:
    ...
    currencyFilterConvertedHint:
      'В режиме «В пересчёте» фильтр остаётся на базовой валюте из «Ещё». Смените её там или включите «В оригинале», чтобы фильтровать по валюте каждого актива.',
  ...
  asset: {
    ...
    addSpendLine: 'Добавить трату',
    removeSpendLine: (index) => `Удалить трату ${index}`,
    spendLineAmount: (index) => `Трата ${index}`,
    spendLineNote: (index) => `Комментарий к трате ${index}`,
  },
  update: {
    title: 'Обновить',
    ...
    spendAmountAria: (name, index) => `Трата ${index} для ${name}`,
    spendNoteAria: (name, index) => `Комментарий к трате ${index} для ${name}`,
  ...
  settings: {
    ...
    showAllCurrenciesHint:
      '«Показать все валюты» — это «В оригинале»: суммы в валюте актива, на Сводке можно фильтровать. Одна валюта — «В пересчёте»: один итог, фильтр на Сводке фиксируется на ней.',
    language: 'Язык',
    languageEn: 'English',
    languageRu: 'Русский',
    skipWelcomeHint:
  ...
  backup: {
    ...
    description:
      'JSON — формат резервной копии и контракт с iOS-приложением. В нём настройки, активы, снимки и курсы. Импорт заменяет эту книгу после подтверждения. Он не сливает данные. CSV по-прежнему добавляет строки.',
    exportJson: 'Экспорт JSON',
    importJson: 'Импорт JSON',
    importAria: 'Импорт JSON-копии',
    replaceHint:
      'Если в книге уже есть активы, импорт сначала спросит и заменит их. Он не сливает данные.',
    replaceConfirm:
      'Это заменит все активы и снимки на этом устройстве файлом. Данные не сливаются. Отмена оставляет то, что здесь.',
    deleteAll: 'Удалить все данные',
    deleteAllConfirm:
      'Это удалит все активы, снимки и курсы на этом устройстве. Отменить нельзя. Сначала экспортируйте JSON, если нужна копия. Отмена оставляет то, что здесь.',
    deleteAllConfirmEmpty:
      'Это очистит оставшийся кэш курсов на этом устройстве. Отмена ничего не меняет.',
    deleted: 'Все данные на этом устройстве удалены.',
    deleteFailed: 'Не удалось удалить данные на этом устройстве.',
  ...
  csv: {
    title: 'CSV',
    description:
      'Таблица снимков, включая заметки. JSON остаётся резервной копией. Импорт добавляет суммы к уже существующим активам; несовпавшие строки показываются, а не отбрасываются.',
